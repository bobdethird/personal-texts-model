...
def extend_jsonl(path: str | Path, records: Iterable[dict[str, Any]]) -> int:
    """Append records, creating the file with private permissions if needed."""
